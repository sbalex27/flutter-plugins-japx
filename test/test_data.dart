...
Future<Map<String, dynamic>> decodingSample8() async =>
    parseJsonFromPath('assets/decoding/decoding-8.json');
...
Future<Map<String, dynamic>> encodingSample7() async =>
    parseJsonFromPath('assets/encoding/encoding-7.json');
...
Future<Map<String, dynamic>> encodingSample11() async =>
    parseJsonFromPath('assets/encoding/encoding-11.json');
...
Future<Map<String, dynamic>> resultDecoding8() async =>
    parseJsonFromPath('assets/result/decoding/result-decoding-8.json');
...
Future<Map<String, dynamic>> resultEncoding7() async =>
    parseJsonFromPath('assets/result/encoding/result-encoding-7.json');
...
Future<Map<String, dynamic>> resultEncoding11() async =>
    parseJsonFromPath('assets/result/encoding/result-encoding-11.json');
